...
class EDZ_RscControlsGroup {
	...
	class VScrollBar : EDZ_RscScrollBar
	{
		width = 0.021;
		autoScrollEnabled = 1;
	};
	
	class HScrollBar : EDZ_RscScrollBar
	{
		height = 0.028;
	};
...
class EDZ_RscControlsGroupNoScrollbars : EDZ_RscControlsGroup {
...
class EDZ_RscListNBox
{
	...
	autoScrollDelay = 5;
	autoScrollRewind = 0;
	class ListScrollBar: EDZ_RscScrollBar{};
	class ScrollBar: EDZ_RscScrollBar{};
};
...
class EDZ_RscTitle : EDZ_RscText {
	style = 0;
	sizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	colorText[] = {0.95, 0.95, 0.95, 1};
};

class EDZ_RscPicture {
	shadow = 0;
	type = 0;
	style = 48;
	sizeEx = 0.023;
...
class EDZ_RscTextMulti : EDZ_RscText
{
	linespacing = 1;
	style = 0 + 16 + 0x200;
};

class EDZ_RscPictureKeepAspect : EDZ_RscPicture 
{
	style = 0x30 + 0x800;
};

class EDZ_RscStructuredText {
	type = 13;
	style = 0;
	x = 0;
	y = 0;
...
class EDZ_RscButtonTextOnly : EDZ_RscButton {
	SizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
	colorBackground[] = {1, 1, 1, 0};
...
class EDZ_RscButtonMenu : EDZ_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
...
class EDZ_RscShortcutButtonMain : EDZ_RscShortcutButton {
	idc = -1;
	style = 0;
	default = 0;
	w = 0.313726;
...
class EDZ_RscBackground : EDZ_RscText {
	type = 0;
	IDC = -1;
	style = 512;
	shadow = 0;
...
class EDZ_RscCombo {
	...
	class ComboScrollBar : EDZ_RscScrollBar {};
};

class EDZ_RscToolbox {
	colorText[] = {0.95, 0.95, 0.95, 1};
	color[] = {0.95, 0.95, 0.95, 1};
